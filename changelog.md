...
- Diagnostics under `--layer` say which file they came from. Two layers with a bad line 2 printed the same thing twice with nothing to tell them apart. A single-file load is unchanged.
